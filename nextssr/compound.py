...
from nextssr.models import CompoundSSR, SequenceAnalysisResult
from nextssr.config import SSRConfig


class CompoundSSRProcessor:
    """Group individual SSRs into compound formations with Weber (1990) Compound Perfect vs
    Compound Disrupted classification."""
